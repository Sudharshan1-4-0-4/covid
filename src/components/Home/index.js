...
import StateWiseRecordComponent from '../StateWiseRecordComponent'
import HomeCaseCardItemComponent from '../HomeCaseCardItemComponent'
import SearchRecommendationComponent from '../SearchRecommendationComponent'
        ...
        <div className="states-records-container">
          {showStateStats && (
            <div className="stats-section">
              ...
              <div className="diff-type-total-case-cards">
                <HomeCaseCardItemComponent stateTotal={sum} />
                {/* Directly return
              ...
              >
                <div className="state-wise-total-table-record">
                  <div className="total-record">
                    <div className="table-head" testid="countryWideConfirmedCases">
