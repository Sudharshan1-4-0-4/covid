...
import CaseCardItemComponent from '../CaseCardItemComponent'
import DistrictItemComponent from '../DistrictItemComponent'
import TimeLineDataComponent from '../TimeLineDataComponent'
...
class StateSpecificDetailsComponent extends Component {
  state = {
  ...
  renderStateSpecificData = () => {
    ...
    return (
      <div className="state-specific-details-route">
        ...
        <TimeLineDataComponent activeCaseClass={activeCaseClass} />
        <Footer />
      </div>
    )
  }
...
export default StateSpecificDetailsComponent
